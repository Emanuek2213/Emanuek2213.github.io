...
class AjaxSolicitudFactura{
    ...
    public function AjaxGenerarFacturaVenta($nro_boleta, $arrIndicador, $arrPrecios, $arrCliente,$linkQR,$factura)
    {
        ...
        $altura = $cantidad * 20 + 190 + $aumento;
        ...
        if ($DatosCliente[0] === "VARIOS" ) {
            ...
            $pdf->SetFont('Times', 'B', 8);
            $pdf->SetX(5);
            $pdf->Cell(0, 5, "Razon Social : ",0,0,'L');
            $pdf->Ln();
            ...
            $pdf->Rect(8,$y + 14+$cant, 64, 0);
            $pdf->Rect(8,$y + 20+$cant, 64, 0);
        ...
        $pdf->Cell(60, 6, utf8_decode("BOLETA ELECTRONICA"),0,0,'C');

        $pdf->Ln();

        $pdf->SetFont('Times', 'B', 12);
        $pdf->Cell(60, 6, utf8_decode("B001 - " .$factura),0,0,'C');
